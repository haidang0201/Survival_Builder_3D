namespace TopsonGames
{
    ...
    public class AnimatorLinkMeshMusketeer : AnimatorLink
    {
        ...
        public MeshAnimation Idle;
        public MeshAnimation Walk;
        public MeshAnimation Attack;
        public MeshAnimation AttackRanged;
        [Tooltip("The animation used when firing from the very first row")]
        public MeshAnimation AttackRangedKneeling;
        public MeshAnimation RaiseShield;
        public MeshAnimation Death;
        public MeshAnimation Knockback;
        ...
        public override void SetBlend(float value)
        {
            ...
            else
            {
                ...
                if ((anim == Attack || anim == AttackRanged || anim == AttackRangedKneeling || anim == Knockback || anim == RaiseShield) && meshAnimator.IsPlaying)
                    return;
        ...
        public override void SetAttackRanged(bool value)
        {
            ...
            else
            {
                ...
                {
                    if (unit.rowInFormation == 1 && AttackRangedKneeling != null)
                    {
                        meshAnimator.Play(AttackRangedKneeling);
                    }
                    else
                    {
                ...
                {
                    var current = meshAnimator.GetCurrentAnimation();
                    if (current == AttackRanged || current == AttackRangedKneeling)
                    {
                        meshAnimator.Play(Idle);
                    }
                }
