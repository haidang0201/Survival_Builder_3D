...
Shader "Vefects/SH_Vefects_VFX_URP_Fire_Hydrant_Main_Stream_02"
{
	Properties
	{
		...
		_PanSpeedDroplets("Pan Speed Droplets", Vector) = (-0.1,-1.17,0,0)
	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float temp_output_59_0 = saturate( ( saturate( ( ( tex2D( _FireSprinklerTexture, panner70 ).r - temp_output_58_0 ) - ( 1.0 - streamStrength125 ) ) ) * _ThickPartsOpacity ) );
				...
				float op62 = saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( temp_output_147_0 + saturate( ( _MistOpacity * streamStrength125 ) ) ) ) * ( 1.0 - saturate( texCoord149.y ) ) ) ) * distanceDepth36 ) ) * ( 1.0 - fresnelNode1_g14 ) ) ) * cameraDepthFade111 ) );
				...
				float3 tanNormal1_g19 = float4( norm100 , 0.0 ).rgb;
				float temp_output_4_0_g19 = _FresnelPower;
				float lerpResult3_g19 = lerp( ( -1.0 * temp_output_4_0_g19 ) , temp_output_4_0_g19 , ase_vface);
				float fresnelNdotV1_g19 = dot( float3(dot(tanToWorld0,tanNormal1_g19), dot(tanToWorld1,tanNormal1_g19), dot(tanToWorld2,tanNormal1_g19)), ase_viewDirWS );
				float fresnelNode1_g19 = ( _FresnelBias + _FresnelScale * pow( 1.0 - fresnelNdotV1_g19, lerpResult3_g19 ) );
				float cameraDepthFade185 = (( eyeDepth -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float opNoMist190 = saturate( ( saturate( ( saturate( ( saturate( ( temp_output_147_0 * ( 1.0 - saturate( texCoord175.y ) ) ) ) * distanceDepth178 ) ) * ( 1.0 - fresnelNode1_g19 ) ) ) * cameraDepthFade185 ) );
				...
				float Occlusion = 1;
				float Alpha = ( op62 * input.ase_color.a );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input , bool ase_vface : SV_IsFrontFace) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( op62 * input.ase_color.a );
...
Node;AmplifyShaderEditor.CommentaryNode;215;-5298,2126;Inherit;False;2596;1362.85;WPO;21;195;197;199;198;200;202;203;205;206;211;212;213;204;214;209;216;217;218;220;221;222;WPO;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.Vector2Node;72;-7296,-1152;Inherit;False;Property;_PanSpeed;Pan Speed;15;0;Create;True;0;0;0;False;0;False;-0.03,-3;-0.03,-3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;123;-7296,-512;Inherit;False;Property;_PanSpeedDroplets;Pan Speed Droplets;18;0;Create;True;0;0;0;False;0;False;-0.1,-1.17;-0.1,-1.17;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;213;-5248,2816;Inherit;False;Property;_WPOUVScale;WPO UV Scale;27;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;212;-4608,2560;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;211;-4352,2816;Inherit;False;Property;_WPOPanSpeed;WPO Pan Speed;28;0;Create;True;0;0;0;False;0;False;0.1,-3;0.1,-3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.FunctionNode;181;-1024,-1920;Inherit;False;DoubleSidedFresnel;-1;;19;64ed426cf297c5b48b5b91bdfa24d4b5;0;4;10;COLOR;0,0,1,0;False;7;FLOAT;0;False;6;FLOAT;1;False;4;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CameraDepthFade;185;-384,-1936;Inherit;False;3;2;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;224;-2816,-1792;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;225;-512,1024;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;228;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;225;0;63;0
WireConnection;225;1;29;4
...
WireConnection;40;6;225;0
WireConnection;40;8;201;0
ASEEND*/
//CHKSM=F54DE8EA14AB70570293810C8633496F93173AA4