...
Shader "Vefects/SH_Vefects_VFX_URP_Garden_Hose_Stream_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord1_g25 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord1_g25 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g25 = (float2(_TilingX , 1.0));
				float2 appendResult5_g25 = (float2(( _TimeParameters.x * 3.0 ) , 0.0));
				float4 tex2DNode94 = tex2D( _HoseTextureNormal, ( float3( ( ( texCoord1_g25 * appendResult4_g25 ) + appendResult5_g25 ) ,  0.0 ) + float3( 0,0,0 ) ).xy );
				float3 lerpResult235 = lerp( float3(0,0,1) , tex2DNode94.rgb , _NormalIntensity);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 texCoord1_g25 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g25 = (float2(_TilingX , 1.0));
				float2 appendResult5_g25 = (float2(( _TimeParameters.x * 3.0 ) , 0.0));
				float4 tex2DNode94 = tex2D( _HoseTextureNormal, ( float3( ( ( texCoord1_g25 * appendResult4_g25 ) + appendResult5_g25 ) ,  0.0 ) + float3( 0,0,0 ) ).xy );
...
Node;AmplifyShaderEditor.SimpleTimeNode;275;-4736,-2048;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;282;-4224,-2048;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;284;-4736,-1792;Inherit;False;Property;_TilingX;Tiling X;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;274;-3968,-2048;Inherit;False;SH_F_Vefects_VFX_UV_Controls;-1;;25;10de39a6392c86b479f4efe7e9856584;0;6;12;FLOAT3;0,0,0;False;8;FLOAT;1;False;11;FLOAT;0;False;9;FLOAT;1;False;10;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TexturePropertyNode;78;-3456,-2432;Inherit;True;Property;_HoseTextureNormal;Hose Texture Normal;6;0;Create;True;0;0;0;False;3;Space(33);Header(Normals);Space(13);False;5ca22024af7c2e3418c8343b38bf8c41;5ca22024af7c2e3418c8343b38bf8c41;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-1664,-1152;Inherit;False;Property;_DepthFade;Depth Fade;10;0;Create;True;0;0;0;False;3;Space(33);Header(Depth Fade);Space(13);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;133;-2560,-1536;Inherit;False;Property;_OpacityMult;Opacity Mult;5;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;283;-2944,-1408;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;248;-2560,-1408;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;116;-384,-1024;Inherit;False;Property;_CameraDepthFadeOffset;Camera Depth Fade Offset;12;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;115;-384,-1152;Inherit;False;Property;_CameraDepthFadeLength;Camera Depth Fade Length;11;0;Create;True;0;0;0;False;3;Space(33);Header(Camera Depth Fade);Space(13);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;287;-128,-1280;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;279;-4736,-1920;Inherit;False;278;panSpeed;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;281;-4480,-1920;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;17;-2048,0;Inherit;False;ConstantBiasScale;-1;;27;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT2;0,0;False;1;FLOAT;-0.5;False;2;FLOAT;2;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-2304,640;Inherit;False;Property;_NormalDistortionIntensity;Normal Distortion Intensity;8;0;Create;True;0;0;0;False;0;False;0.25;0.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;236;-2944,-2048;Inherit;False;Constant;_Vector1;Vector 1;32;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.LerpOp;235;-2688,-2048;Inherit;True;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;100;-2432,-2048;Inherit;False;norm;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;278;-256,1664;Inherit;False;panSpeed;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;288;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=594C0B702E5C8AB83930A2ABD7B69F9B16865607