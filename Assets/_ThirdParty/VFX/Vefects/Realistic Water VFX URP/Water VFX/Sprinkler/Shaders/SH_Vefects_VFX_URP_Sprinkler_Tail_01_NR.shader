...
Shader "Vefects/SH_Vefects_VFX_URP_Sprinkler_Tail_01_NR"
{
	Properties
	{
		...
		_PowerEdges( "Power Edges", Float ) = 2
	...
	LOD 0
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float streamLengthPercentage125 = ( _StreamLengthPercentage * input.texcoord.w );
				float lerpResult222 = lerp( 0.1 , 1.0 , streamLengthPercentage125);
				...
				float random312 = input.texcoord.z;
				float4 tex2DNode199 = tex2Dlod( _WPOTexture, float4( ( panner197 + random312 ), 0, 0.0) );
				float2 texCoord205 = input.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float3 WPO200 = ( ( ( float3( 0, 1, 0 ) * ( ( ( tex2DNode199.g + -0.5 ) * 2.0 ) * _WPOStrength ) ) * 1.0 ) * saturate( texCoord205.y ) );
						...
						, uint ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float random312 = input.ase_texcoord7.z;
				float2 panner300 = ( 1.0 * _Time.y * _SprinklerUVPan + ( ( texCoord297 + random312 ) * _SprinklerUVScale ));
				float3 lerpResult235 = lerp( float3( 0, 0, 1 ) , tex2D( _SprinklerTextureNormal, panner300 ).rgb , _NormalIntensity);
				float3 norm100 = lerpResult235;
				float streamLengthPercentage125 = ( _StreamLengthPercentage * input.ase_texcoord7.w );
				float2 texCoord289 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord284 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord195 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult222 = lerp( 0.1 , 1.0 , streamLengthPercentage125);
				float2 appendResult218 = (float2(texCoord195.x , ( texCoord195.y * lerpResult222 )));
				float2 panner197 = ( 1.0 * _Time.y * _WPOPanSpeed + ( appendResult218 * _WPOUVScale ));
				float4 tex2DNode199 = tex2D( _WPOTexture, ( panner197 + random312 ) );
				...
				float3 tanNormal1_g26 = float4( 0,0,1,0 ).rgb;
				float temp_output_4_0_g26 = _FresnelPower;
				float lerpResult3_g26 = lerp( ( -1.0 * temp_output_4_0_g26 ) , temp_output_4_0_g26 , ase_vface);
				float fresnelNdotV1_g26 = dot( float3( dot( tanToWorld0, tanNormal1_g26 ), dot( tanToWorld1, tanNormal1_g26 ), dot( tanToWorld2, tanNormal1_g26 ) ), ViewDirWS );
				float fresnelNode1_g26 = ( _FresnelBias + _FresnelScale * pow( 1.0 - fresnelNdotV1_g26, lerpResult3_g26 ) );
				...
				float op62 = saturate( ( saturate( ( saturate( ( saturate( ( ( saturate( ( saturate( ( saturate( ( ( tex2D( _SprinklerTexture, panner300 ).g - saturate( pow( abs( ( ( texCoord289.x + -0.5 ) * 2.0 ) ) , _PowerEdges ) ) ) * ( 1.0 - saturate( texCoord284.y ) ) ) ) * _OpacityMult ) ) * tex2DNode199.g ) ) * lerpResult303 ) * distanceDepth36 ) ) * ( 1.0 - fresnelNode1_g26 ) ) ) * saturate( cameraDepthFade111 ) ) ) * input.ase_color.a ) );
				float3 temp_output_19_0 = ( norm100 * ( ( _NormalDistortionIntensity * streamLengthPercentage125 ) * op62 ) );
				float dotResult319 = dot( float4( temp_output_19_0 , 0.0 ) , _FakeShadowSelector );
				float lerpResult321 = lerp( 1.0 , saturate( dotResult319 ) , _FakeShadowIntensity);
				float3 temp_output_324_0 = ( lerpResult321 * _Color01 );
				
				float3 temp_cast_2 = (_Specular).xxx;
				

				float3 BaseColor = temp_output_324_0;
				float3 Normal = norm100;
				float3 Specular = temp_cast_2;
				float Metallic = 0;
				float Smoothness = _Smoothness;
				float Occlusion = 1;
				float3 Emission = ( temp_output_324_0 * _EmissionIntensity );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float streamLengthPercentage125 = ( _StreamLengthPercentage * input.ase_texcoord.w );
				float lerpResult222 = lerp( 0.1 , 1.0 , streamLengthPercentage125);
				float2 appendResult218 = (float2(texCoord195.x , ( texCoord195.y * lerpResult222 )));
				float2 panner197 = ( 1.0 * _Time.y * _WPOPanSpeed + ( appendResult218 * _WPOUVScale ));
				float random312 = input.ase_texcoord.z;
				float4 tex2DNode199 = tex2Dlod( _WPOTexture, float4( ( panner197 + random312 ), 0, 0.0) );
						...
						, uint ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float random312 = input.ase_texcoord1.z;
				float2 panner300 = ( 1.0 * _Time.y * _SprinklerUVPan + ( ( texCoord297 + random312 ) * _SprinklerUVScale ));
				float2 texCoord289 = input.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord284 = input.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float temp_output_4_0_g26 = _FresnelPower;
				float lerpResult3_g26 = lerp( ( -1.0 * temp_output_4_0_g26 ) , temp_output_4_0_g26 , ase_vface);
				float fresnelNdotV1_g26 = dot( float3( dot( tanToWorld0, tanNormal1_g26 ), dot( tanToWorld1, tanNormal1_g26 ), dot( tanToWorld2, tanNormal1_g26 ) ), ase_viewDirWS );
				float fresnelNode1_g26 = ( _FresnelBias + _FresnelScale * pow( 1.0 - fresnelNdotV1_g26, lerpResult3_g26 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input , uint ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float random312 = input.ase_texcoord3.z;
				float2 panner300 = ( 1.0 * _Time.y * _SprinklerUVPan + ( ( texCoord297 + random312 ) * _SprinklerUVScale ));
				float3 lerpResult235 = lerp( float3( 0, 0, 1 ) , tex2D( _SprinklerTextureNormal, panner300 ).rgb , _NormalIntensity);
				float3 norm100 = lerpResult235;
				float streamLengthPercentage125 = ( _StreamLengthPercentage * input.ase_texcoord3.w );
				float2 texCoord289 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord284 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=19909
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;174;-818,1358;Inherit;False;1331;435.95;Strength;5;125;126;226;227;312;Strength;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;215;-5298,2126;Inherit;False;2596;1362.85;WPO;26;195;197;199;198;200;202;203;205;206;211;212;204;214;209;216;218;220;221;222;240;274;276;277;278;313;314;WPO;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;312;-256,1664;Inherit;False;random;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;289;-5760,-2560;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;297;-7936,-1792;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;316;-7808,-2048;Inherit;False;312;random;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;291;-5376,-2560;Inherit;True;ConstantBiasScale;-1;;25;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;-0.5;False;2;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;299;-7552,-1664;Inherit;False;Property;_SprinklerUVScale;Sprinkler UV Scale;16;0;Create;True;0;0;0;False;0;False;1,1;1,3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleAddOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;315;-7424,-2048;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;293;-4736,-2304;Inherit;False;Property;_PowerEdges;Power Edges;11;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;292;-5120,-2560;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;221;-5248,3072;Inherit;False;125;streamLengthPercentage;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;298;-7552,-1792;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;301;-7168,-1664;Inherit;False;Property;_SprinklerUVPan;Sprinkler UV Pan;17;0;Create;True;0;0;0;False;0;False;0.777,3.333;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;284;-5760,-2048;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;290;-4736,-2560;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;52;-6272,-2048;Inherit;True;Property;_SprinklerTexture;Sprinkler Texture;15;0;Create;True;0;0;0;False;3;Space(33);Header(Mask);Space(13);False;d9bd7890e7f34e54a83b375c260d9b90;d9bd7890e7f34e54a83b375c260d9b90;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.PannerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;300;-7168,-1792;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;285;-5504,-2048;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;294;-4480,-2560;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;286;-5248,-2048;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;295;-5760,-1792;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;240;-4608,2816;Inherit;False;Property;_WPOUVScale;WPO UV Scale;26;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;287;-4992,-1920;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;211;-4352,2816;Inherit;False;Property;_WPOPanSpeed;WPO Pan Speed;27;0;Create;True;0;0;0;False;0;False;0.1,-3;0.1,-3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;288;-4736,-1920;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;314;-4736,2304;Inherit;False;312;random;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;313;-4352,2304;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;281;-4224,-1408;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;279;-3968,-1408;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;49;-1024,-1280;Inherit;False;DoubleSidedFresnel;-1;;26;64ed426cf297c5b48b5b91bdfa24d4b5;0;4;10;COLOR;0,0,1,0;False;7;FLOAT;0;False;6;FLOAT;1;False;4;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;116;-384,-1024;Inherit;False;Property;_CameraDepthFadeOffset;Camera Depth Fade Offset;23;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;115;-384,-1152;Inherit;False;Property;_CameraDepthFadeLength;Camera Depth Fade Length;22;0;Create;True;0;0;0;False;3;Space(33);Header(Camera Depth Fade);Space(13);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;317;-128,-1280;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;204;-3712,3200;Inherit;False;Property;_WPOStrength;WPO Strength;25;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;216;-3712,2560;Inherit;False;ConstantBiasScale;-1;;27;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;-0.5;False;2;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;214;-3456,2560;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;276;-3584,2304;Inherit;False;Constant;_Vector0;Vector 0;31;0;Create;True;0;0;0;False;0;False;0,1,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;274;-3328,2304;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;278;-3200,2432;Inherit;False;Constant;_Float0;Float 0;31;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;277;-3200,2304;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;327;-506.2061,1138.185;Inherit;False;Property;_OpMult;Op Mult;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;326;-528,1024;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;17;-2048,0;Inherit;False;ConstantBiasScale;-1;;28;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT2;0,0;False;1;FLOAT;-0.5;False;2;FLOAT;2;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;33;-2304,640;Inherit;False;Property;_NormalDistortionIntensity;Normal Distortion Intensity;13;0;Create;True;0;0;0;False;0;False;0.25;0.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;237;-5504,-384;Inherit;False;Property;_NormalIntensity;Normal Intensity;14;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;236;-5760,-640;Inherit;False;Constant;_Vector1;Vector 1;32;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;235;-5504,-640;Inherit;True;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;94;-6272,-640;Inherit;True;Property;_TextureSample2;Texture Sample 0;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;100;-5248,-640;Inherit;False;norm;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;78;-6272,-1024;Inherit;True;Property;_SprinklerTextureNormal;Sprinkler Texture Normal;12;0;Create;True;0;0;0;False;3;Space(33);Header(Normals);Space(13);False;177e5fb9126d4ff4d9674815f03e88be;177e5fb9126d4ff4d9674815f03e88be;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.Vector4Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;318;-1932.495,1429.392;Inherit;False;Property;_FakeShadowSelector;Fake Shadow Selector;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DotProductOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;319;-1932.495,1301.392;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;320;-1804.495,1301.392;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;321;-1548.495,1045.392;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;322;-1548.495,1173.392;Inherit;False;Property;_FakeShadowIntensity;Fake Shadow Intensity;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;323;-1804.495,1045.392;Inherit;False;Constant;_Float3;Float 1;29;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;324;-1292.495,1045.392;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;325;-256,1024;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;328;0,100;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;14;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;329;0,100;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;XRMotionVectors;0;11;XRMotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;14;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;True;1;False;;255;False;;1;False;;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;False;True;1;LightMode=XRMotionVectors;False;False;0;;0;0;Standard;0;False;0
WireConnection;312;0;227;3
WireConnection;226;0;126;0
WireConnection;226;1;227;4
WireConnection;291;3;289;1
WireConnection;125;0;226;0
WireConnection;315;0;297;0
WireConnection;315;1;316;0
WireConnection;292;0;291;0
WireConnection;298;0;315;0
...
WireConnection;94;1;300;0
WireConnection;100;0;235;0
WireConnection;319;0;19;0
