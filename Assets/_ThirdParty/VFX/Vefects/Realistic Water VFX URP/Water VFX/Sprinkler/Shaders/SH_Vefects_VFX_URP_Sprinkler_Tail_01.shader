...
Shader "Vefects/SH_Vefects_VFX_URP_Sprinkler_Tail_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float random312 = input.ase_texcoord9.z;
				...
				float2 texCoord289 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord284 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float streamLengthPercentage125 = ( _StreamLengthPercentage * input.texcoord0.w );
				float lerpResult222 = lerp( 0.1 , 1.0 , streamLengthPercentage125);
				float2 appendResult218 = (float2(texCoord195.x , ( texCoord195.y * lerpResult222 )));
				float2 panner197 = ( 1.0 * _Time.y * _WPOPanSpeed + ( appendResult218 * _WPOUVScale ));
				float random312 = input.texcoord0.z;
				float4 tex2DNode199 = tex2Dlod( _WPOTexture, float4( ( panner197 + random312 ), 0, 0.0) );
			...
			half4 frag(PackedVaryings input , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float random312 = input.ase_texcoord5.z;
				float2 panner300 = ( 1.0 * _Time.y * _SprinklerUVPan + ( ( texCoord297 + random312 ) * _SprinklerUVScale ));
				float3 lerpResult235 = lerp( float3(0,0,1) , tex2D( _SprinklerTextureNormal, panner300 ).rgb , _NormalIntensity);
				float3 norm100 = lerpResult235;
				float streamLengthPercentage125 = ( _StreamLengthPercentage * input.ase_texcoord5.w );
				float2 texCoord289 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord284 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input , bool ase_vface : SV_IsFrontFace) : SV_TARGET
			{
				...
				float random312 = input.ase_texcoord.z;
				float2 panner300 = ( 1.0 * _Time.y * _SprinklerUVPan + ( ( texCoord297 + random312 ) * _SprinklerUVScale ));
				float2 texCoord289 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord284 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=19701
Node;AmplifyShaderEditor.CommentaryNode;174;-818,1358;Inherit;False;1331;435.95;Strength;5;125;126;226;227;312;Strength;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;215;-5298,2126;Inherit;False;2596;1362.85;WPO;26;195;197;199;198;200;202;203;205;206;211;212;204;214;209;216;218;220;221;222;240;274;276;277;278;313;314;WPO;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;312;-256,1664;Inherit;False;random;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;289;-5760,-2560;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;226;-224,1472;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;297;-7936,-1792;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;316;-7808,-2048;Inherit;False;312;random;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;291;-5376,-2560;Inherit;True;ConstantBiasScale;-1;;25;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;-0.5;False;2;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;299;-7552,-1664;Inherit;False;Property;_SprinklerUVScale;Sprinkler UV Scale;13;0;Create;True;0;0;0;False;0;False;1,1;1,3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleAddOpNode;315;-7424,-2048;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;293;-4736,-2304;Inherit;False;Property;_PowerEdges;Power Edges;8;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;292;-5120,-2560;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;221;-5248,3072;Inherit;False;125;streamLengthPercentage;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;298;-7552,-1792;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;301;-7168,-1664;Inherit;False;Property;_SprinklerUVPan;Sprinkler UV Pan;14;0;Create;True;0;0;0;False;0;False;0.777,3.333;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;284;-5760,-2048;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;290;-4736,-2560;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;52;-6272,-2048;Inherit;True;Property;_SprinklerTexture;Sprinkler Texture;12;0;Create;True;0;0;0;False;3;Space(33);Header(Mask);Space(13);False;d9bd7890e7f34e54a83b375c260d9b90;d9bd7890e7f34e54a83b375c260d9b90;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.LerpOp;222;-4864,3072;Inherit;False;3;0;FLOAT;0.1;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;300;-7168,-1792;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SaturateNode;285;-5504,-2048;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;294;-4480,-2560;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;220;-4864,2816;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;286;-5248,-2048;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;295;-5760,-1792;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;218;-4864,2560;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;240;-4608,2816;Inherit;False;Property;_WPOUVScale;WPO UV Scale;23;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;287;-4992,-1920;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;212;-4608,2560;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;211;-4352,2816;Inherit;False;Property;_WPOPanSpeed;WPO Pan Speed;24;0;Create;True;0;0;0;False;0;False;0.1,-3;0.1,-3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SaturateNode;288;-4736,-1920;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;314;-4736,2304;Inherit;False;312;random;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;198;-4096,2176;Inherit;True;Property;_WPOTexture;WPO Texture;21;0;Create;True;0;0;0;False;3;Space(33);Header(WPO);Space(13);False;fe426db6ff66e814ebcc9dafec308df1;fe426db6ff66e814ebcc9dafec308df1;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SimpleAddOpNode;313;-4352,2304;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;199;-4096,2560;Inherit;True;Property;_TextureSample4;Texture Sample 0;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SaturateNode;281;-4224,-1408;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;279;-3968,-1408;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-1664,-1152;Inherit;False;Property;_DepthFade;Depth Fade;18;0;Create;True;0;0;0;False;3;Space(33);Header(Depth Fade);Space(13);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;107;-1024,-896;Inherit;False;Property;_FresnelScale;Fresnel Scale;16;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;108;-1024,-768;Inherit;False;Property;_FresnelPower;Fresnel Power;17;0;Create;True;0;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;106;-1024,-1024;Inherit;False;Property;_FresnelBias;Fresnel Bias;15;0;Create;True;0;0;0;False;3;Space(33);Header(Fresnel);Space(13);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;49;-1024,-1280;Inherit;False;DoubleSidedFresnel;-1;;26;64ed426cf297c5b48b5b91bdfa24d4b5;0;4;10;COLOR;0,0,1,0;False;7;FLOAT;0;False;6;FLOAT;1;False;4;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-384,-1024;Inherit;False;Property;_CameraDepthFadeOffset;Camera Depth Fade Offset;20;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;115;-384,-1152;Inherit;False;Property;_CameraDepthFadeLength;Camera Depth Fade Length;19;0;Create;True;0;0;0;False;3;Space(33);Header(Camera Depth Fade);Space(13);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;204;-3712,3200;Inherit;False;Property;_WPOStrength;WPO Strength;22;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;113;-768,-1408;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;216;-3712,2560;Inherit;False;ConstantBiasScale;-1;;27;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;-0.5;False;2;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;317;-128,-1280;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;112;-384,-1408;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;214;-3456,2560;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;276;-3584,2304;Inherit;False;Constant;_Vector0;Vector 0;31;0;Create;True;0;0;0;False;0;False;0,1,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;274;-3328,2304;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;278;-3200,2432;Inherit;False;Constant;_Float0;Float 0;31;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;277;-3200,2304;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;640,0;Inherit;False;Property;_Cull;Cull;25;0;Create;True;0;0;0;True;3;Space(33);Header(AR);Space(13);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;1664,0;Inherit;False;Property;_ZTest;ZTest;29;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;896,0;Inherit;False;Property;_Src;Src;26;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;1152,0;Inherit;False;Property;_Dst;Dst;27;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;1408,0;Inherit;False;Property;_ZWrite;ZWrite;28;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;17;-2048,0;Inherit;False;ConstantBiasScale;-1;;28;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT2;0,0;False;1;FLOAT;-0.5;False;2;FLOAT;2;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;237;-5504,-384;Inherit;False;Property;_NormalIntensity;Normal Intensity;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;236;-5760,-640;Inherit;False;Constant;_Vector1;Vector 1;32;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.LerpOp;235;-5504,-640;Inherit;True;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;94;-6272,-640;Inherit;True;Property;_TextureSample2;Texture Sample 0;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RegisterLocalVarNode;100;-5248,-640;Inherit;False;norm;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TexturePropertyNode;78;-6272,-1024;Inherit;True;Property;_SprinklerTextureNormal;Sprinkler Texture Normal;9;0;Create;True;0;0;0;False;3;Space(33);Header(Normals);Space(13);False;177e5fb9126d4ff4d9674815f03e88be;177e5fb9126d4ff4d9674815f03e88be;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;318;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=60F3516C08903DBB6CBB48C8FD9FE32BC9748F9E