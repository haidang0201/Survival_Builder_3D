...
Shader "Vefects/SH_Vefects_VFX_URP_Pressure_Washer_Stream_02"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float temp_output_150_0 = saturate( texCoord149.y );
				...
				float op62 = saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( saturate( ( ( tex2D( _HydrantTexture, panner70 ).r - ( 1.0 - saturate( texCoord56.y ) ) ) - ( 1.0 - streamStrength125 ) ) ) * _ThickPartsOpacity ) ) + saturate( ( _MistOpacity * streamStrength125 ) ) ) ) * temp_output_150_0 ) ) * distanceDepth36 ) ) * ( 1.0 - fresnelNode1_g14 ) ) ) * cameraDepthFade111 ) ) * input.ase_color.a ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-8320,-896;Inherit;False;Property;_TilingY;Tiling Y;13;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;65;-8320,-1024;Inherit;False;Property;_TilingX;Tiling X;12;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;72;-7296,-1152;Inherit;False;Property;_PanSpeed;Pan Speed;14;0;Create;True;0;0;0;False;0;False;-0.03,-3;-0.03,-3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;237;-6016,0;Inherit;False;Property;_NormalIntensity;Normal Intensity;10;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;78;-6784,-640;Inherit;True;Property;_HydrantTextureNormal;Hydrant Texture Normal;8;0;Create;True;0;0;0;False;3;Space(33);Header(Normals);Space(13);False;612f2c484b632aa4baa8d6c64ae4972e;612f2c484b632aa4baa8d6c64ae4972e;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
ASEEND*/
//CHKSM=1F939AD621499FE39950E3E1C85B9A4A7A205493