...
Shader "Vefects/SH_Vefects_URP_VFX_Vignette_Water_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 texCoord442 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord325 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float randomUV533 = input.ase_texcoord5.z;
				...
				float2 texCoord381 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float lerpResult453 = lerp( 1.0 , _DistortionMaxMultiplier , ( saturate( temp_output_503_0 ) * saturate( input.ase_texcoord4.z ) ));
				float4 fetchOpaqueVal259 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( (ase_grabScreenPosNorm).xy * lerpResult453 ) ), 1.0 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = fetchOpaqueVal259.rgb;
				float Alpha = saturate( temp_output_503_0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 texCoord442 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord325 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float aspectRatio468 = ( _ScreenParams.x / _ScreenParams.y );
				float2 appendResult470 = (float2(( ( aspectRatio468 / 1.78 ) * _DripsHorizontalTiling ) , 1.0));
				float4 tex2DNode474 = tex2D( _DripsTexture, ( texCoord325 * appendResult470 ) );
				float temp_output_486_0 = ( texCoord442.y + ( tex2DNode474.b * _DripsSepparation ) );
				float lerpResult493 = lerp( ( 1.0 - temp_output_486_0 ) , temp_output_486_0 , _DripsDirection);
				float2 appendResult485 = (float2(texCoord442.x , lerpResult493));
				float randomUV533 = input.ase_texcoord4.z;
				float2 panner439 = ( 1.0 * _Time.y * _DripsSpeed + ( appendResult485 + randomUV533 ));
				float4 tex2DNode437 = tex2D( _DripsMaskTexture, panner439 );
				float dripsAlpha484 = ( tex2DNode437.g * tex2DNode474.a );
				float2 texCoord381 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float aspectRatio02506 = ( _ScreenParams.x / _ScreenParams.y );
				float2 appendResult509 = (float2(( aspectRatio02506 / 1.78 ) , 1.0));
				float4 tex2DNode352 = tex2D( _DropsTexture, ( texCoord381 * appendResult509 ) );
				float temp_output_517_0 = ( saturate( ( ( frac( ( tex2DNode352.b - ( _TimeParameters.x * _DropsSpawnRate ) ) ) + -0.5 ) * 2.0 ) ) * tex2DNode352.a );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 texCoord442 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord325 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float aspectRatio468 = ( _ScreenParams.x / _ScreenParams.y );
				float2 appendResult470 = (float2(( ( aspectRatio468 / 1.78 ) * _DripsHorizontalTiling ) , 1.0));
				float4 tex2DNode474 = tex2D( _DripsTexture, ( texCoord325 * appendResult470 ) );
				float temp_output_486_0 = ( texCoord442.y + ( tex2DNode474.b * _DripsSepparation ) );
				float lerpResult493 = lerp( ( 1.0 - temp_output_486_0 ) , temp_output_486_0 , _DripsDirection);
				float2 appendResult485 = (float2(texCoord442.x , lerpResult493));
				float randomUV533 = input.ase_texcoord1.z;
				float2 panner439 = ( 1.0 * _Time.y * _DripsSpeed + ( appendResult485 + randomUV533 ));
				float4 tex2DNode437 = tex2D( _DripsMaskTexture, panner439 );
				float dripsAlpha484 = ( tex2DNode437.g * tex2DNode474.a );
				float2 texCoord381 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float aspectRatio02506 = ( _ScreenParams.x / _ScreenParams.y );
				float2 appendResult509 = (float2(( aspectRatio02506 / 1.78 ) , 1.0));
				float4 tex2DNode352 = tex2D( _DropsTexture, ( texCoord381 * appendResult509 ) );
				float temp_output_517_0 = ( saturate( ( ( frac( ( tex2DNode352.b - ( _TimeParameters.x * _DropsSpawnRate ) ) ) + -0.5 ) * 2.0 ) ) * tex2DNode352.a );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float2 texCoord442 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord325 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float aspectRatio468 = ( _ScreenParams.x / _ScreenParams.y );
				float2 appendResult470 = (float2(( ( aspectRatio468 / 1.78 ) * _DripsHorizontalTiling ) , 1.0));
				float4 tex2DNode474 = tex2D( _DripsTexture, ( texCoord325 * appendResult470 ) );
				float temp_output_486_0 = ( texCoord442.y + ( tex2DNode474.b * _DripsSepparation ) );
				float lerpResult493 = lerp( ( 1.0 - temp_output_486_0 ) , temp_output_486_0 , _DripsDirection);
				float2 appendResult485 = (float2(texCoord442.x , lerpResult493));
				float randomUV533 = input.ase_texcoord3.z;
				float2 panner439 = ( 1.0 * _Time.y * _DripsSpeed + ( appendResult485 + randomUV533 ));
				float4 tex2DNode437 = tex2D( _DripsMaskTexture, panner439 );
				float dripsAlpha484 = ( tex2DNode437.g * tex2DNode474.a );
				float2 texCoord381 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float aspectRatio02506 = ( _ScreenParams.x / _ScreenParams.y );
				float2 appendResult509 = (float2(( aspectRatio02506 / 1.78 ) , 1.0));
				float4 tex2DNode352 = tex2D( _DropsTexture, ( texCoord381 * appendResult509 ) );
				float temp_output_517_0 = ( saturate( ( ( frac( ( tex2DNode352.b - ( _TimeParameters.x * _DropsSpawnRate ) ) ) + -0.5 ) * 2.0 ) ) * tex2DNode352.a );
...
Node;AmplifyShaderEditor.RangedFloatNode;471;-4864,2048;Inherit;False;Property;_DripsHorizontalTiling;Drips Horizontal Tiling;3;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;351;-4480,-256;Inherit;True;Property;_DropsTexture;Drops Texture;8;0;Create;True;0;0;0;False;3;Space(33);Header(Drops Texture);Space(13);False;74826fc78a27f3f42a37712516842e80;74826fc78a27f3f42a37712516842e80;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SimpleTimeNode;522;-3712,-128;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;524;-3712,0;Inherit;False;Property;_DropsSpawnRate;Drops Spawn Rate;10;0;Create;True;0;0;0;False;0;False;0.25;0.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;487;-5120,2944;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;494;-4864,3072;Inherit;False;Property;_DripsDirection;Drips Direction;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;441;-4352,2944;Inherit;False;Property;_DripsSpeed;Drips Speed;6;0;Create;True;0;0;0;False;0;False;0,-0.5;0,-0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;479;-3072,1792;Inherit;False;Property;_DripsNormalStrength;Drips Normal Strength;2;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;512;-2560,384;Inherit;False;Property;_DropsNormalStrength;Drops Normal Strength;9;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;500;-1152,-256;Inherit;False;Property;_DistortionMaxMultiplier;Distortion Max Multiplier;0;0;Create;True;0;0;0;False;0;False;1.1;1.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;536;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;1;2;259;0
WireConnection;1;3;529;0
ASEEND*/
//CHKSM=F85D4B6908D2E7FA7977C6DA4A01685A99E69B5F