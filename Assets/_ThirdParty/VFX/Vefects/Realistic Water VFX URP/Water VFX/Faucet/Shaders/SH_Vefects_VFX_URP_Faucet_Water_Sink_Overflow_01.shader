...
Shader "Vefects/SH_Vefects_VFX_URP_Faucet_Water_Sink_Overflow_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord9.z = customEye170;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 texCoord338 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner148 = ( 1.0 * _Time.y * _Water01PanSpeed + ( texCoord338 * _Water01UVScale ));
				float2 texCoord344 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _Water02PanSpeed + ( texCoord344 * _Water02UVScale ));
				float2 texCoord347 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float customEye170 = input.ase_texcoord9.z;
				...
				float3 BaseColor = ( float4( _Color01 , 0.0 ) * fetchOpaqueVal23 ).rgb;
				float3 Normal = WaterNormal140;
				float3 Emission = ( _Color01 * _Emission );
				float3 Specular = temp_cast_5;
				float Metallic = 0;
				float Smoothness = smoothness90;
				float Occlusion = 1;
				float Alpha = saturate( ( input.ase_color.a * saturate( ( saturate( ( saturate( ( DF59 * DSFres181 ) ) * camDF183 ) ) * vMask354 ) ) ) ).r;
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 customSurfaceDepth170 = input.positionOS.xyz;
				float customEye170 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth170)).z;
				output.ase_texcoord3.w = customEye170;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float temp_output_178_0 = fresnelNode1_g65;
				float DSFres181 = saturate( temp_output_178_0 );
				float customEye170 = input.ase_texcoord3.w;
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
				float2 texCoord347 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float4 vMask354 = ( saturate( ( saturate( pow( saturate( texCoord347.y ) , _VerticalMaskPower ) ) * _VerticalMaskMultiply ) ) * input.ase_color );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 customSurfaceDepth170 = input.positionOS.xyz;
				float customEye170 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth170)).z;
				output.ase_texcoord5.z = customEye170;
			...
			half4 frag(PackedVaryings input , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float2 panner148 = ( 1.0 * _Time.y * _Water01PanSpeed + ( texCoord338 * _Water01UVScale ));
				float2 texCoord344 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _Water02PanSpeed + ( texCoord344 * _Water02UVScale ));
				float2 texCoord347 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 vMask354 = ( saturate( ( saturate( pow( saturate( texCoord347.y ) , _VerticalMaskPower ) ) * _VerticalMaskMultiply ) ) * input.ase_color );
				float4 temp_output_346_0 = ( _WaterNormalStrength * vMask354 );
				float3 appendResult138 = (float3(temp_output_346_0.r , temp_output_346_0.r , 1.0));
				float3 WaterNormal140 = ( ( tex2D( _WaterNormal, panner148 ).rgb + tex2D( _WaterNormal, panner143 ).rgb ) * appendResult138 );
				...
				float temp_output_178_0 = fresnelNode1_g65;
				float DSFres181 = saturate( temp_output_178_0 );
				float customEye170 = input.ase_texcoord5.z;
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input , bool ase_vface : SV_IsFrontFace) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = saturate( ( input.ase_color.a * saturate( ( saturate( ( saturate( ( DF59 * DSFres181 ) ) * camDF183 ) ) * vMask354 ) ) ) ).r;
...
Node;AmplifyShaderEditor.CommentaryNode;337;-7986,1742;Inherit;False;3620;978.8501;Water;21;148;143;164;165;133;134;132;135;138;139;136;137;140;338;339;341;342;343;344;346;357;Water;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;347;-6144,2816;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-3200,1408;Inherit;False;Property;_DepthFadeOpacity;Depth Fade Opacity;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;349;-5888,2816;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;355;-5504,2944;Inherit;False;Property;_VerticalMaskPower;Vertical Mask Power;5;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;352;-5504,2816;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;353;-5376,2816;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;356;-5120,2944;Inherit;False;Property;_VerticalMaskMultiply;Vertical Mask Multiply;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;350;-5120,2816;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;351;-4992,2816;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;361;-5248,3072;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;362;-4864,3072;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;173;-1280,768;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;354;-4736,2816;Inherit;False;vMask;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;174;-1024,768;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;360;-768,640;Inherit;False;354;vMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;358;-768,768;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;29;-1280,384;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;359;-512,768;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;-896,384;Inherit;False;2;2;0;FLOAT;1;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SaturateNode;186;-640,384;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;325;-2432,1408;Inherit;False;Property;_DepthFadeColor;Depth Fade Color;7;0;Create;True;0;0;0;False;0;False;3;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;331;-128,-384;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;17;-2560,0;Inherit;False;ConstantBiasScale;-1;;70;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT2;0,0;False;1;FLOAT;-0.5;False;2;FLOAT;2;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;140;-4608,2048;Inherit;False;WaterNormal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.PannerNode;148;-7168,2048;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;143;-7168,2432;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;133;-6784,2048;Inherit;True;Property;_TextureSample2;Texture Sample 0;24;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;134;-6784,2432;Inherit;True;Property;_TextureSample3;Texture Sample 0;24;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.TexturePropertyNode;132;-6784,1792;Inherit;True;Property;_WaterNormal;Water Normal;9;0;Create;True;0;0;0;False;3;Space(33);Header(Water Normal);Space(13);False;d96e50eec907e1c428a285fb1124a713;d96e50eec907e1c428a285fb1124a713;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SimpleAddOpNode;135;-6400,2048;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Vector2Node;165;-7168,2560;Inherit;False;Property;_Water02PanSpeed;Water 02 Pan Speed;14;0;Create;True;0;0;0;False;0;False;-0.69,-0.69;-0.025,-0.025;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;339;-7552,2048;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;342;-7552,2432;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;338;-7936,2048;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;344;-7936,2432;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;341;-7552,2176;Inherit;False;Property;_Water01UVScale;Water 01 UV Scale;11;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;343;-7552,2560;Inherit;False;Property;_Water02UVScale;Water 02 UV Scale;13;0;Create;True;0;0;0;False;0;False;1.69,1.69;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;164;-7168,2176;Inherit;False;Property;_Water01PanSpeed;Water 01 Pan Speed;12;0;Create;True;0;0;0;False;0;False;0.777,0.777;0.025,0.025;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;136;-6144,2048;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;139;-6144,2544;Inherit;False;Constant;_Float2;Float 2;29;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;334;-640,-1664;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;138;-5760,2304;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;137;-6144,2304;Inherit;False;Property;_WaterNormalStrength;Water Normal Strength;10;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;346;-5888,2304;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;357;-6144,2432;Inherit;False;354;vMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;49;-2304,-1152;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;335;-2304,-1024;Inherit;False;59;DF;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;363;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=4BBE8B6C0E53FA4D7C2E1DD5279F9BECB925E584