...
Shader "Vefects/SH_Vefects_VFX_URP_Pressure_Washer_Stream_01_NR"
{
	Properties
	{
		...
		[Space(33)][Header(Distortion)][Space(13)] _PressureDistortionTextureNormal( "Pressure Distortion Texture Normal", 2D ) = "white" {}
		[Space(33)][Header(Normals)][Space(13)] _PressureTextureNormal( "Pressure Texture Normal", 2D ) = "white" {}
		_NormalDistortionIntensity( "Normal Distortion Intensity", Float ) = 0.25
		_NormalIntensity( "Normal Intensity", Float ) = 1
		[Space(33)][Header(Mask)][Space(13)] _PressureTexture( "Pressure Texture", 2D ) = "white" {}
		_TilingX( "Tiling X", Float ) = 1
		_TilingY( "Tiling Y", Float ) = 1
		_PanSpeed( "Pan Speed", Vector ) = ( 0, -3, 0, 0 )
	...
	LOD 0
		...
		Pass
		{
			...
			sampler2D _PressureDistortionTextureNormal;
			sampler2D _PressureTextureNormal;
						...
						, uint ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float streamLengthPercentage125 = _StreamLengthPercentage;
				float2 uv_PressureTexture = input.ase_texcoord7.xy * _PressureTexture_ST.xy + _PressureTexture_ST.zw;
				float4 tex2DNode53 = tex2D( _PressureTexture, uv_PressureTexture );
				float2 texCoord244 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult250 = lerp( 1.0 , saturate( texCoord244.y ) , streamLengthPercentage125);
				float2 texCoord1_g21 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g21 = (float2(1.0 , 1.0));
				float2 appendResult5_g21 = (float2(0.0 , 0.0));
				float2 texCoord55 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g19 = (float2(_TilingX , ( _TilingY * streamLengthPercentage125 )));
				float2 appendResult5_g19 = (float2(0.0 , 0.0));
				float2 panner70 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord55 * appendResult4_g19 ) + appendResult5_g19 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord262 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult266 = lerp( _UVNoiseStrength , 0.0 , saturate( ( saturate( texCoord262.y ) - 0.5 ) ));
				...
				float3 tanNormal1_g22 = float4( 0,0,1,0 ).rgb;
				float temp_output_4_0_g22 = _FresnelPower;
				float lerpResult3_g22 = lerp( ( -1.0 * temp_output_4_0_g22 ) , temp_output_4_0_g22 , ase_vface);
				float fresnelNdotV1_g22 = dot( float3( dot( tanToWorld0, tanNormal1_g22 ), dot( tanToWorld1, tanNormal1_g22 ), dot( tanToWorld2, tanNormal1_g22 ) ), ViewDirWS );
				float fresnelNode1_g22 = ( _FresnelBias + _FresnelScale * pow( 1.0 - fresnelNdotV1_g22, lerpResult3_g22 ) );
				...
				float op62 = saturate( ( saturate( ( saturate( ( saturate( ( ( ( tex2DNode53.r * ( lerpResult250 * tex2D( _PressureTexture, ( float3( ( ( texCoord1_g21 * appendResult4_g21 ) + appendResult5_g21 ) ,  0.0 ) + float3( ( ( ( (tex2D( _PressureDistortionTextureNormal, panner70 ).rgb).xy + -0.5 ) * 2.0 ) * lerpResult266 ) ,  0.0 ) ).xy ).g ) ) * _OpacityMult ) * distanceDepth36 ) ) * ( 1.0 - fresnelNode1_g22 ) ) ) * saturate( cameraDepthFade111 ) ) ) * input.ase_color.a ) );
				float temp_output_32_0 = ( ( _NormalDistortionIntensity * streamLengthPercentage125 ) * op62 );
				float3 lerpResult235 = lerp( float3( 0, 0, 1 ) , tex2D( _PressureTextureNormal, panner70 ).rgb , _NormalIntensity);
				float3 norm100 = lerpResult235;
				float dotResult279 = dot( float4( norm100 , 0.0 ) , _FakeShadowSelector );
				float lerpResult277 = lerp( 1.0 , ( temp_output_32_0 * saturate( dotResult279 ) ) , _FakeShadowIntensity);
				float3 temp_output_283_0 = ( _Color01 * lerpResult277 );
				
				float3 temp_cast_7 = (_Specular).xxx;
				

				float3 BaseColor = temp_output_283_0;
				float3 Normal = norm100;
				float3 Specular = temp_cast_7;
				float Metallic = 0;
				float Smoothness = _Smoothness;
				float Occlusion = 1;
				float3 Emission = ( temp_output_283_0 * _EmissionIntensity );
				float Alpha = op62;
		...
		Pass
		{
						...
						, uint ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 uv_PressureTexture = input.ase_texcoord1.xy * _PressureTexture_ST.xy + _PressureTexture_ST.zw;
				float4 tex2DNode53 = tex2D( _PressureTexture, uv_PressureTexture );
				float2 texCoord244 = input.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float streamLengthPercentage125 = _StreamLengthPercentage;
				float lerpResult250 = lerp( 1.0 , saturate( texCoord244.y ) , streamLengthPercentage125);
				...
				float2 appendResult5_g19 = (float2(0.0 , 0.0));
				float2 panner70 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord55 * appendResult4_g19 ) + appendResult5_g19 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord262 = input.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult266 = lerp( _UVNoiseStrength , 0.0 , saturate( ( saturate( texCoord262.y ) - 0.5 ) ));
				float screenDepth36 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ScreenPosNorm.xy ),_ZBufferParams);
				float distanceDepth36 = saturate( ( screenDepth36 - LinearEyeDepth( ScreenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				...
				float temp_output_4_0_g22 = _FresnelPower;
				float lerpResult3_g22 = lerp( ( -1.0 * temp_output_4_0_g22 ) , temp_output_4_0_g22 , ase_vface);
				float fresnelNdotV1_g22 = dot( float3( dot( tanToWorld0, tanNormal1_g22 ), dot( tanToWorld1, tanNormal1_g22 ), dot( tanToWorld2, tanNormal1_g22 ) ), ase_viewDirWS );
				float fresnelNode1_g22 = ( _FresnelBias + _FresnelScale * pow( 1.0 - fresnelNdotV1_g22, lerpResult3_g22 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input , uint ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float streamLengthPercentage125 = _StreamLengthPercentage;
				float2 uv_PressureTexture = input.ase_texcoord3.xy * _PressureTexture_ST.xy + _PressureTexture_ST.zw;
				float4 tex2DNode53 = tex2D( _PressureTexture, uv_PressureTexture );
				float2 texCoord244 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult250 = lerp( 1.0 , saturate( texCoord244.y ) , streamLengthPercentage125);
				...
				float2 appendResult5_g19 = (float2(0.0 , 0.0));
				float2 panner70 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord55 * appendResult4_g19 ) + appendResult5_g19 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord262 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult266 = lerp( _UVNoiseStrength , 0.0 , saturate( ( saturate( texCoord262.y ) - 0.5 ) ));
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;66;-8832,512;Inherit;False;Property;_TilingY;Tiling Y;14;0;Create;True;0;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;252;-8832,640;Inherit;False;125;streamLengthPercentage;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;65;-8832,384;Inherit;False;Property;_TilingX;Tiling X;13;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;55;-8832,0;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;254;-8448,512;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;72;-7808,256;Inherit;False;Property;_PanSpeed;Pan Speed;15;0;Create;True;0;0;0;False;0;False;0,-3;0,-3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;64;-8192,0;Inherit;False;SH_F_Vefects_VFX_UV_Controls;-1;;19;10de39a6392c86b479f4efe7e9856584;0;6;12;FLOAT3;0,0,0;False;8;FLOAT;1;False;11;FLOAT;0;False;9;FLOAT;1;False;10;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;262;-6784,512;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;255;-6784,-256;Inherit;True;Property;_PressureDistortionTextureNormal;Pressure Distortion Texture Normal;8;0;Create;True;0;0;0;False;3;Space(33);Header(Distortion);Space(13);False;fe426db6ff66e814ebcc9dafec308df1;d96e50eec907e1c428a285fb1124a713;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.PannerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;70;-7552,0;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;263;-6528,512;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;256;-6784,0;Inherit;True;Property;_TextureSample3;Texture Sample 0;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleSubtractOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;264;-6272,512;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;265;-6144,512;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;267;-6144,384;Inherit;False;Property;_UVNoiseStrength;UV Noise Strength;31;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;268;-6368,0;Inherit;False;True;True;False;True;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;126;-768,1408;Inherit;False;Property;_StreamLengthPercentage;Stream Length Percentage;2;0;Create;True;0;0;0;False;3;Space(0);Header(Strength);Space(13);False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;266;-5888,512;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;258;-6144,0;Inherit;False;ConstantBiasScale;-1;;20;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT2;0,0;False;1;FLOAT;-0.5;False;2;FLOAT;2;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;259;-5888,0;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;244;-6272,-1024;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;257;-7168,-640;Inherit;False;SH_F_Vefects_VFX_UV_Controls;-1;;21;10de39a6392c86b479f4efe7e9856584;0;6;12;FLOAT3;0,0,0;False;8;FLOAT;1;False;11;FLOAT;0;False;9;FLOAT;1;False;10;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;251;-6272,-896;Inherit;False;125;streamLengthPercentage;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;245;-6016,-1024;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;52;-6784,-1792;Inherit;True;Property;_PressureTexture;Pressure Texture;12;0;Create;True;0;0;0;False;3;Space(33);Header(Mask);Space(13);False;684936b3d5f41c04aa4dabbba4eb0cb4;684936b3d5f41c04aa4dabbba4eb0cb4;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;246;-6784,-640;Inherit;True;Property;_TextureSample1;Texture Sample 0;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;250;-5760,-1024;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;273;-5248,-640;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;38;-1664,-1152;Inherit;False;Property;_DepthFade;Depth Fade;19;0;Create;True;0;0;0;False;3;Space(33);Header(Depth Fade);Space(13);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;133;-4608,-1536;Inherit;False;Property;_OpacityMult;Opacity Mult;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;247;-4992,-1408;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;107;-1024,-896;Inherit;False;Property;_FresnelScale;Fresnel Scale;17;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;108;-1024,-768;Inherit;False;Property;_FresnelPower;Fresnel Power;18;0;Create;True;0;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;106;-1024,-1024;Inherit;False;Property;_FresnelBias;Fresnel Bias;16;0;Create;True;0;0;0;False;3;Space(33);Header(Fresnel);Space(13);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;248;-4608,-1408;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;49;-1024,-1280;Inherit;False;DoubleSidedFresnel;-1;;22;64ed426cf297c5b48b5b91bdfa24d4b5;0;4;10;COLOR;0,0,1,0;False;7;FLOAT;0;False;6;FLOAT;1;False;4;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;116;-384,-1024;Inherit;False;Property;_CameraDepthFadeOffset;Camera Depth Fade Offset;21;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;115;-384,-1152;Inherit;False;Property;_CameraDepthFadeLength;Camera Depth Fade Length;20;0;Create;True;0;0;0;False;3;Space(33);Header(Camera Depth Fade);Space(13);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;274;-128,-1280;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;240;-4608,2816;Inherit;False;Property;_WPOUVScale;WPO UV Scale;24;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;211;-4352,2816;Inherit;False;Property;_WPOPanSpeed;WPO Pan Speed;25;0;Create;True;0;0;0;False;0;False;0.1,-3;0.1,-3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;204;-3712,3200;Inherit;False;Property;_WPOStrength;WPO Strength;23;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;216;-3712,2560;Inherit;False;ConstantBiasScale;-1;;23;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;-0.5;False;2;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;10;640,0;Inherit;False;Property;_Cull;Cull;26;0;Create;True;0;0;0;True;3;Space(33);Header(AR);Space(13);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;14;1664,0;Inherit;False;Property;_ZTest;ZTest;30;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;11;896,0;Inherit;False;Property;_Src;Src;27;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;12;1152,0;Inherit;False;Property;_Dst;Dst;28;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;13;1408,0;Inherit;False;Property;_ZWrite;ZWrite;29;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;17;-2048,0;Inherit;False;ConstantBiasScale;-1;;24;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT2;0,0;False;1;FLOAT;-0.5;False;2;FLOAT;2;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;103;-768,0;Inherit;False;Property;_EmissionIntensity;Emission Intensity;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;105;-768,768;Inherit;False;Property;_Smoothness;Smoothness;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;104;-768,512;Inherit;False;Property;_Specular;Specular;5;0;Create;True;0;0;0;False;0;False;0.01;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;33;-2304,640;Inherit;False;Property;_NormalDistortionIntensity;Normal Distortion Intensity;10;0;Create;True;0;0;0;False;0;False;0.25;0.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;26;-1280,-384;Inherit;False;Property;_Color01;Color 01;3;0;Create;True;0;0;0;False;3;Space(33);Header(Attributes);Space(13);False;1,1,1,0;1,1,1,0;True;False;0;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;237;-6016,1920;Inherit;False;Property;_NormalIntensity;Normal Intensity;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;236;-6272,1664;Inherit;False;Constant;_Vector1;Vector 1;32;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;235;-6016,1664;Inherit;True;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;100;-5760,1664;Inherit;False;norm;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;78;-6784,1280;Inherit;True;Property;_PressureTextureNormal;Pressure Texture Normal;9;0;Create;True;0;0;0;False;3;Space(33);Header(Normals);Space(13);False;d96e50eec907e1c428a285fb1124a713;d96e50eec907e1c428a285fb1124a713;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;94;-6784,1664;Inherit;True;Property;_TextureSample2;Texture Sample 0;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;270;-5760,-1152;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;272;-5504,-1152;Inherit;False;refractionMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;281;-2176,1024;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;277;-1920,896;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;275;-1920,1024;Inherit;False;Property;_FakeShadowIntensity;Fake Shadow Intensity;0;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;282;-2688,1152;Inherit;False;100;norm;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Vector4Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;278;-2688,1280;Inherit;False;Property;_FakeShadowSelector;Fake Shadow Selector;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DotProductOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;279;-2432,1152;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;280;-2304,1152;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;283;-1152,896;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;284;-2176,896;Inherit;False;Constant;_Float0;Float 0;32;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
WireConnection;274;0;111;0
WireConnection;112;0;113;0
WireConnection;112;1;274;0
...
ASEEND*/
//CHKSM=02B11ADF06C048CF4F0448AF97AC8BE4912CA75E