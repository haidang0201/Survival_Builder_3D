namespace TopsonGames
{
    ...
    [CreateAssetMenu(fileName = "CavalrySingleCombatSO", menuName = "TopsonGames/Combat Behaviours/Cavalry (Single Mesh)")]
    public class CavalrySingleCombatSO : CombatBehaviourSO
    {
